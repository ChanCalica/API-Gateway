...
{
    public partial class Loyalty_Robinsons_PreProdContext : DbContext
    {
        public Loyalty_Robinsons_PreProdContext()
        {
        }

        public Loyalty_Robinsons_PreProdContext(DbContextOptions<Loyalty_Robinsons_PreProdContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<CrmMember20220128> CrmMember20220128s { get; set; } = null!;
        ...
        public virtual DbSet<CrmMemberDev> CrmMemberDevs { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=azsshqltydv01.database.windows.net; User Id=hqdb_reader; Password=s36IapseIQIy; Database=Loyalty_Robinsons_PreProd; Trusted_Connection=False;Encrypt=True; timeout=30;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CrmMember>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.UpdatedDate, e.MobilePhoneNumber }, "IX_CRM_Member_1");

                entity.HasIndex(e => e.MemberInternalKey, "nci_wi_CRM_Member_10CA407BF539B94921221F6D2F0B01F7");

                entity.HasIndex(e => e.ExternalMemberKey, "nci_wi_CRM_Member_6EA2F17C6C4167D4DB8135DA389D55B4");

                entity.HasIndex(e => e.MobilePhoneNumber, "nci_wi_CRM_Member_CD4462A0F3C9AB9417C89F04C6EED888");

                entity.HasIndex(e => e.EmailAddress, "nci_wi_CRM_Member_E57EFB4B0C014F02D4CE64E339F2E360");
            ...
            modelBuilder.Entity<CrmMember20220128>(entity =>
            {
                entity.HasKey(e => e.MemberInternalKey)
                    .HasName("PK_Member");

                entity.ToTable("CRM_Member_20220128");

                entity.HasIndex(e => new { e.MobilePhoneNumber, e.BirthDate, e.LastName }, "IX_CRM_Member");
            ...
            modelBuilder.Entity<CrmMemberDev>(entity =>
            {
                entity.HasKey(e => e.MemberSk)
                    .HasName("PK__CRM_Memb__42A63AE89B514767");

                entity.ToTable("CRM_Member_Dev");

                entity.Property(e => e.MemberSk).HasColumnName("Member_SK");
